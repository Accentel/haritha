                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Expences List</div>
                            </div>
					                            ...
					                            <div class="card card-topline-red">
					                                ...
					                                <div class="card-body ">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
															<?php 
															$sq=mysqli_query($link,"select * from expenses order by id desc");
															$i=1;
															...
															?>
																<tr class="odd gradeX">
																	...
																	<td>
																		...
																		<a href="../db/delete_exppense.php?id=<?php echo $r['id']; ?>" onclick="confirm('are you sure delete a record?');" class="btn btn-danger btn-xs">
