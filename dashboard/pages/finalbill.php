...
xmlhttp.send();
		...
		?>
                                    <form action="finalbilllist.php" id="form_sample_1" class="form-horizontal" autocomplete="on" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
...
<div id="productdetails" class="form-group row" > <table width="100%" class="ruler" id="TABLE1"></table>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_lab_amnt" id="tlamount" placeholder=" Total Lab Amount" class="form-control" value="0" />
                                                </div>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" name="tot_pharma_amnt" id="tpamount" placeholder=" Total Pharmacy Amount" class="form-control" value="0"/>
                                                </div>
