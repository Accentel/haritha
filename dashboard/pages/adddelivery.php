...
{
$ses=$_SESSION['user'];
include('../db/insert_delivery.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        <div class="form-body">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="mrno"  id="mrno" placeholder="Enter MR NO" class="form-control " value="" required/>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="name"  id="name" placeholder="Enter Name" class="form-control " value="" required/>
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="age"  id="age" placeholder="Enter Age" class="form-control " value="" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="gender"  id="gender" placeholder="Enter Gender" class="form-control " value="" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="mobile"  id="mobile" placeholder="Enter Mobile No" class="form-control " value="" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="date" name="ddate"  id="ddate" placeholder="Enter Delivery Date" class="form-control " value="" required/>
