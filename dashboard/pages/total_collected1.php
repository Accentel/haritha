...
-->
         ...
         <td>
          ...
          <td>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab'");
			$k1=mysqli_fetch_array($as);
			echo $elab=$k1['elab'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $celab=$k1['elab'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as elab from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Lab' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdelab=$k1['elab'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as epes from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package Extra Service'");
			$k1=mysqli_fetch_array($as);
			echo $epes=$k1['epes'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as epes from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package Extra Service' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			echo $cepes=$k1['epes'];
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as epes from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package Extra Service'  and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
			echo $cdepes=$k1['epes'];
			?>
            ...
            <td>
             <?php $as=mysqli_query($link,"select sum(amount) as efbill from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package FinalBill'");
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as efbill from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package FinalBill' and pay_type='Cash'");
			$k1=mysqli_fetch_array($as);
			...
			?>
             ...
             <td>
             <?php $as=mysqli_query($link,"select sum(amount) as efbill from daily_amount where date_time between '$time2' and '$time3' and recv_by='$recv_by' and amnt_type='Package FinalBill' and pay_type='Card'");
			$k1=mysqli_fetch_array($as);
