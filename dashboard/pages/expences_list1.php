                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Expences Type List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Expences Type List</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                        ...
                                        <div class="row">
										   ...
										   value="" >Add New Expenses Type</button>
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
															<?php 
															$sq=mysqli_query($link,"select * from expenses_type order by id desc");
															$i=1;
															...
															?>
																<tr class="odd gradeX">
																	...
																	<td>
																		<!--<a href="edit_expenses.php?id=<?php echo $r['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>-->
																			 <button type="button" class="btn btn-success" onclick=" window.open('expses_type1.php?id=<?php echo $r['id'];?>','',' scrollbars=yes,menubar=no,width=500, resizable=yes,toolbar=no,location=no,status=no')"
										   value="" >Edit</button>
																		</a>
