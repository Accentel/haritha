...
<input type="radio" onclick="javascript:location.href='patientregister2.php'" required="required"  name="new" id="new" value="Existing"/> Existing</td>
 ...
 value="<?php echo date('d-m-y'); ?>"  placeholder=""/></td><td>
...
-->
											...
											<div class="form-group">
	                                            <label>Have Ref Doctor?</label>
											
											<select name="have_ref" class="form-control" onChange="funconcekk2(this.value);" >
     ...
     <option value="Yes">Yes</option>
        ...
        <!--<option value="Insurence">Insurence</option>-->
											...
											<div class="form-group">
												...
												<select name="payment_type" class="form-control" onChange="funcash(this.value);" required>
...
<input type="hidden" class="form-control"  name="rel"  id="rel"  />								
										...
										<input type="hidden" class="form-control" name="con_doct_mob" id="con_doct_mob" />
                                           <input type="hidden" class="text" name="concession_type" id="concession_type"  value="card"/>
										   <input type="hidden" class="form-control" name="ref_mob" id="ref_mob" />
										<!--<div class="form-group">
...
<?php } } ?>
	                      ...
	                      -->                  </div>
                                            ...
                                            <div class="form-group" id="kkk" style="display:none">
...
<?php } } ?>
									 ...
									 <div class="form-group" id="rec_type1">
