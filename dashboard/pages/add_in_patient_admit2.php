 ...
 //$cnt=mysql_num_rows($abcd);
	//$row2=mysqli_fetch_array($abcd1);
	 ...
	 // $valid=date('Y-m-d', strtotime("+$valid_days days"));
	  //$id=$_GET['id'];
	//  $sq1=mysqli_query($link,"select * from patientregister where 	reg_id='$id'");
...
?>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" value="<?php echo $r1['age'];?>" name="age" id="age" readonly />
											</td></tr></table>
  ...
  ?>
    ...
    Card
										...
										<div class="form-group">
												...
												<input type="text" name="rnum" class="form-control" value="<?php echo $r1['registerno'];?>" onclick="javascript:window.open('patient_popup.php','mypatwindow','width=500,height=500,toolbar=no,resizable=yes,menubar=no')"
 ...
 /></td></tr></table>
										 ...
										 <div class="form-group">
                                            <label>Patient Name :</label>
											 ...
											 <input name="pname" id="patname" readonly="readonly"  class="form-control" value="<?php echo $r1['patientname'];?>" type="text"  size="20"  required="required"
 />
										...
										<div class="form-group">
                                            <label>Gender :</label>
											 ...
											 <input name="sex" id="gen1" readonly="readonly" value="<?php echo $r1['gender'];?>"  class="form-control" type="text"  size="20"  required="required"
 />
