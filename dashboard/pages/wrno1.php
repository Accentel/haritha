...
function stateChanged(){ 
	...
	//alert('<%=current_date%>')
			...
			opener.document.getElementById("doa").value=strar[3];
...
<tr height="25px"><TH>PATIENT NAME</TH><TH>MR NO.</TH><TH>Gender</TH></tr>
<?php 
			  include("../db/connection.php");
			   ...
			   if(isset($_REQUEST['submit'])){
				$mno=$_REQUEST['mno'];
				$wno=$_REQUEST['wno'];
				$sq=mysqli_query($link,"select a.registerno,a.patientname,a.gender,b.PAT_ID from patientregister a , ip_pat_admit b where a.registerno=b.PAT_REGNO and  a.patientname='$wno' or b.PAT_REGNO='$mno'");
				if($sq)
			   {
             ...
             <tr height="25px"><td style="text-align:center;"><input type="radio" name="empid" value="<?php echo $a ?>" onclick="javascript:showDoc(this.value);"/><?php echo $h ?></td><td><?php echo $r ?></td><td><?php echo $a1;?></td></tr>
				 ...
				 <?php }
				  ...
				  $x="select a.registerno,a.patientname,a.gender,b.PAT_ID from patientregister a, ip_pat_admit b where a.registerno=b.PAT_REGNO  ";
			...
			if($sq){	
             ...
             <input type="radio" name="empid" value="<?php echo $a ?>" onclick="javascript:showDoc(this.value);"/><?php echo $h;?></td>
			 <td><?php echo $r ?></td>
			 <td><?php echo $a1 ?></td>
			 </tr>
             <?php }
