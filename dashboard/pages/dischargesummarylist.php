					                                    ...
					                                    <div class="table-scrollable">
															...
															<?php	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td class="left"><?php echo date('d-m-Y',strtotime($res['doa'])); ?></td>
																	<td class="left"><?php echo date('d-m-Y',strtotime($res['dod'])); ?></td>
																	<td>
																		<a href="edit_dischargesummary.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a  onclick="window.open('print_discharge.php?id=<?php echo $crud->my_simple_crypt($res['id'],'e'); ?>','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')" class="btn btn-primary btn-xs">
