...
$pdf->Cell(30, 6, 'Pro.Name', 0, 0, 'C', FALSE);
$pdf->Cell(55, 6, 'Supp.Name', 0, 0, 'C', FALSE);
$pdf->Cell(25, 6, 'Exp.Dt', 0, 0, 'C', FALSE);
$pdf->Cell(25, 6, 'SQty', 0, 0, 'C', FALSE);
$pdf->Cell(30, 6, 'VAT', 0, 0, 'C', FALSE);
$pdf->Cell(30, 6, 'Value', 0, 1, 'C', FALSE);
...
$pdf->Cell(30, 6, $row1[1], 0, 0, 'C', FALSE);
$pdf->Cell(55, 6, $row1[2], 0, 0, 'L', FALSE);
$pdf->Cell(15, 6,   date('d-m-Y',strtotime($row1[3])) , 0, 0, 'C', FALSE);
$pdf->Cell(30, 6, $row1[4], 0, 0, 'C', FALSE);
$pdf->Cell(30, 6, $row1[5], 0, 0, 'C', FALSE);
$pdf->Cell(30, 6, $row1[6], 0, 1, 'C', FALSE);	
$tot2=$row1[6];
$tot3=($tot3+$tot2);
$counts++;
