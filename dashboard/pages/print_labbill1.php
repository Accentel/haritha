...
<THEAD>
<tr><td colspan="2"><img src="../img/raajto.png" style="width:100%; height:120px;"/>  </td></tr>
...
$crud = new Crud();
  ...
  <tr>
	...
	<tr>
          <td height="100" colspan="3" align="center"><input type="button" value="Print" id="prnt" class="butt" onclick="prnt();"/> <a href="labreultlist.php"><input type="button" value="Close"  class="butt"/></a></td>
      </tr>
