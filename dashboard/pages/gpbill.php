                                ...
                                <div class="card-body" id="bar-parent">
                                    ...
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
                                        ...
                                        <div class="form-group row" id="mid">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="mrno" id="mrno" placeholder="Enter MRNO" class="form-control mrno" onclick="window.open('wrno.php','mywindow','width=700,height=500,toolbar=no,menubar=no,scrollbars=yes')"  readonly     onChange="showHint5(this.value)"/> 
													 </div>
