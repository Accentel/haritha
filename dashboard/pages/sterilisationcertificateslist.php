...
window.open('sterilisation_print.php?id='+b+'','mywindow','width=700,height=500,toolbar=no,menubar=no');
	}
	</script>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class="pull-left">
                                <div class="page-title">Sterilisation Certificates List</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Sterilisation Certificates Bill</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="addsterilisatoin.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
															<?php 
															$result=mysqli_query($link,"select * from sterilation_certificate") or die(mysqli_error($link));
															$i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<td>
																	<a href="edit_sterilisation.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																			<i class="fa fa-pencil"></i>
																		</a>
																		<a href="../db/delete_sterilisation.php?id=<?php echo $res['id']; ?>" onclick="confirm('Delete record?')" class="btn btn-danger btn-xs">
