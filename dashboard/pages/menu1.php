	                    ...
	                    <ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="nav-item">
	                           ...
	                           <ul class="sub-menu">
	                                ...
	                                </li><?php }if($menu203== "203"){ ?>
								
									
									<li class="nav-item  ">
	                                    <a href="birth_format.php" class="nav-link ">
	                                        <span class="title">Birth Certificate Format</span>
	                                        <span class="selected"></span>
	                                    </a>
	                                </li><?php }if($menu204== "204"){ ?>
									<li class="nav-item  ">
	                                   <a href="dbirth_format.php" class="nav-link ">
	                                        <span class="title">Delivery / Birth Certificate Format</span>
	                                        <span class="selected"></span>
	                                    </a>
	                                </li><?php }if($menu205== "205"){ ?>
									<li class="nav-item  ">
	                                     <a href="sterilisation_format.php" class="nav-link ">
	                                        <span class="title">Sterilisation Certificate Format</span>
	                                        <span class="selected"></span>
	                                    </a>
	                         ...
	                         <?php if($menu4 == "4"){ ?><li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
									...
									<?php }if($menu44== "44"){ ?>
	                                <li class="nav-item  ">
	                                    <a href="prescriptionlist.php" class="nav-link "> <span class="title">Prescription List</span>
	                                    </a>
	                                    </a>
	                                </li>
									<?php }if($menu45== "45"){ ?>
	                        ...
	                        <li class="nav-item  ">
	                            ...
	                            <ul class="sub-menu">
	                               <?php if($menu51 == "51"){ ?> <li class="nav-item  ">
	                                ...
	                                <li class="nav-item  ">
	                                     <a href="deliverylist.php" class="nav-link "> <span class="title">Delivery Form</span>
	                                    </a>
	                                </li><?php }if($menu53== "53"){ ?>
	                                <li class="nav-item  ">
