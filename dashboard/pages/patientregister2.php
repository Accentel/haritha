...
<?php } } ?>
										...
										<div class="form-group">
											...
											<div class="form-group">
												...
												<select name="payment_type" class="form-control"  onChange="funcash(this.value);"" >
...
<?php } else  if($gender=='female'){?>  
								...
								<?php }?>
										...
										<input type="hidden" class="form-control" name="con_doct_mob" value="<?php echo $con_doc_mob?>"  id="con_doct_mob" />
...
<?php } } ?>
                                           ...
                                           <input type="hidden" required="required" value="0" name="fee" id="rec_type1" class="form-control" onkeyup="calculateSum();"/>
