...
{
$ses=$_SESSION['user'];
include('../db/update_delivery.php');
include("header.php");?>
			 <!-- end sidebar menu -->
			<!-- start page content -->
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Add Delivery Details</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Add Delivery Details</li>
                            </ol>
                        </div>
                    </div>
                    <div class="row">
                                ...
                                <div class="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" class="form-horizontal" method="post">
										...
										<?php	foreach ($result as $key => $res) { ?>	
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="mrno"  id="mrno" placeholder="Enter MR NO" class="form-control " value="<?php echo $res['mrno']; ?>" required/>
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="name"  id="name" placeholder="Enter Name" class="form-control " value="<?php echo $res['name']; ?>" required/>
											 ...
											 <div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="age"  id="age" placeholder="Enter Age" class="form-control " value="<?php echo $res['age']; ?>" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="gender"  id="gender" placeholder="Enter Gender" class="form-control " value="<?php echo $res['gender']; ?>" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" name="mobile"  id="mobile" placeholder="Enter Mobile No" class="form-control " value="<?php echo $res['mobile']; ?>" required/>
											...
											<div class="form-group row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="date" name="ddate"  id="ddate" placeholder="Enter Delivery Date" class="form-control " value="<?php echo $res['ddate']; ?>" required/>
