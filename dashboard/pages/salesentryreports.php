...
function report()
{
	...
	if (document.form.tdate.value == "") {
	  ...
	  window.open('pdf_salesentry.php?s_date='+s_date+'&e_date='+e_date,'mywindow1','width=1020,height=800,toolbar=no,menubar=no,scrollbars=yes')
                ...
                <div class="page-content">
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            <div class=" pull-left">
                                <div class="page-title">Sales Entry Report(Patient Wise)</div>
                            </div>
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Sales Entry Reports(Patient Wise)</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Sales Entry Reports(Patient Wise)</header>
