	                                    ...
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
											 ...
											 <div class="form-group">
												...
												<option value="Female" <?php if($r['gender']=="Female"){echo 'selected';} ?>>Female</option></select>
...
?>
	                                   ...
	                                   <input type="text" class="form-control" required="required" name="doctorshare" id="doctorshare" value="<?php echo $r['doct_share'];?>">
	                                        </div>
											-->
