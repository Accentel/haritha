...
function reportxx(){
	...
	window.open('total_hospitalpatients1.php?sdate='+fdate+'&edate='+tdate+'&dname='+dname,'Mywindow','width=1020,height=800,toolbar=no,menubar=no');
}
</script>		
                    ...
                    <div class="page-bar">
                        <div class="page-title-breadcrumb">
                            ...
                            <ol class="breadcrumb page-breadcrumb pull-right">
                                ...
                                <li class="active">Doctor Wise Patients Report</li>
                            </ol>
                        </div>
                    </div>
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
                            <div class="card card-box">
                                <div class="card-head">
                                    <header>Doctor Wise Patients Report</header>
                                ...
                                <div class="card-body " id="bar-parent2">
                                	<div class="row">
									   ...
									   <div class="form-group">
	                                            ...
	                                            <select class="form-control" required="required"  name="dname" id="dname" >
												<option value="">Select Doctor</option>
												<?php
											$q=mysqli_query($link,"select * from doct_infor") or die(mysqli_error($link));
											while($q1=mysqli_fetch_array($q)){		
											?>
											<option value="<?php echo $q1['dname1']; ?>"><?php echo $q1['dname1']; ?></option>
											<?php }?>
												</select>
	                                        </div>
