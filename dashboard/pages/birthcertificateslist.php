					                                ...
					                                <div class="card-body ">
					                                    <div class="row">
					                                        <div class="col-md-6 col-sm-6 col-xs-6">
					                                            <div class="btn-group">
					                                                <a href="addbirthcertificate.php" id="addRow" class="btn btn-info">
					                                    ...
					                                    <div class="table-scrollable">
					                                        ...
					                                        <tbody>
															<?php 
															$result=mysqli_query($link,"select * from birth_certificate") or die(mysqli_error($link));
															$i=1;	foreach ($result as $key => $res) { ?>
																<tr class="odd gradeX">
																	...
																	<a href="edit_birthcertificate.php?id=<?php echo $res['id']; ?>" class="btn btn-primary btn-xs">
																		...
																		<a href="../db/delete_birthcertificate.php?id=<?php echo $res['id']; ?>" onclick="confirm(' Delete  record?')" class="btn btn-danger btn-xs">
