									...
									<div class="form-group">
										...
										<div class="form-group">
                                            <label>Adjustables</label>
	                                            <input type="text" class="form-control" name="adjt" value="<?php echo $adjust?>"  id="adjt" onkeyup="javascript:adjttotal()" >
                                        </div>
										<div class="form-group">
                                            <label>Rounded</label>
	                                            <input type="text" class="form-control" name="round" value="<?php echo $round?>"  id="round" onkeyup="javascript:adjttotal()">
                                        </div>
										<div class="form-group">
