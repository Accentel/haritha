...
<table width="100%" cellpadding="0" cellspacing="0"> 
    ...
    <tr>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0">
            <tr>
                <td class="header"><b> <?php echo $dname; ?> </b>Patients List</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            <tr>
                <td>
                    <table cellpadding="4" cellspacing="0" width="100%" border="1">
                        ...
                        <?php
						$h="select * from patientregister where doctorname='$dname' and date between '$sdate' and '$edate'";
                   // echo  $h="select distinct a.registerno,a.gender,a.tokenno,a.patientname,a.pat_type,a.age,a.phoneno,a.ref_doc,a.date,b.ref_docname,b.refcode from patientregister a,referal_doctor b where a.ref_doc=b.refcode and a.doctorname='$dname' and a.date between '$sdate1' and '$edate1' order by a.registerno asc";
						$qry=mysqli_query($link,$h) or die(mysqli_error($link));
						if($qry){
						$i=0;
