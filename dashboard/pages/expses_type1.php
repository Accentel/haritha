                ...
                <div class="page-content">
					...
					<div class="row">
                        <div class="col-md-12 col-sm-12">
							...
							$id=$_POST['id'];
								  $a="update  expenses_type set name='$expenses' where id='$id'";
							
								$sq=mysqli_query($link,$a);
								if($sq){
									print "<script>";
	print "alert('Successfully Registered');";
	print "self.location='expences_list1.php';";
	print "</script>";
								...
								$id=$_GET['id'];
								$sq=mysqli_query($link,"select * from expenses_type where id='$id'");
                                	...
                                	<div class="row">
	                                    <div class="col-md-6 col-sm-6">
	                                        ...
	                                        <div class="form-group">
                                                ...
                                                <input type="text" name="expenses" value="<?php echo $r['name'];?>" id="expenses" required="required" class="form-control" />
												</div>
